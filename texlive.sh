...
# a few more packages
tlmgr install   luacode environ adjustbox collectbox ms varwidth geometry url ulem standalone luatex85 tikzmarmots tikzducks pgf-blur inconsolata tools caption hyperref metalogo fancyvrb mdwtools titlesec tocloft pdfpages listings
